...
FORM_CLASS1, _ = uic.loadUiType(os.path.join(os.path.dirname(__file__),'corridor_detection_selection_dialog_base.ui'))
class SelectionDialog(QtWidgets.QDialog, FORM_CLASS1):
